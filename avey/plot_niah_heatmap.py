# modified from https://github.com/howard-hou/RWKV-X/blob/main/evaluation/pass_key_rwkv.py
...
def parse_config():
	...
	parser.add_argument('--model_path', type=str, default="avey-ai/avey1-dpa-1.5B-100BT")
...
def main(args):
	...
	model = Avey.from_pretrained(
		args.model_path
	).to(device)
	model.set_to_generation_mode()
